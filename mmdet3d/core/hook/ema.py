...
class MEGVIIEMAHook(Hook):
    ...
    def before_train_epoch(self, runner):
        print(f"============ Begin Training Epoch {runner.epoch + 1} ===============")
        if "VeonT" in runner.model.module._get_name():
            runner.model.module.loss_occ.proj2dto3dloss.epoch = runner.epoch
            print(f"Setting epoch number {runner.epoch + 1} succeeded. ")
