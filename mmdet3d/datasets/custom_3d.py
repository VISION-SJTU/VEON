...
class Custom3DDataset(Dataset):
    ...
    def __init__(self,
        ...
        # load annotations
        is_not_semkitti = self.ann_file.endswith('.pkl')
        if is_not_semkitti:
            ...
            warnings.warn("No .pkl suffix in annotation filename, maybe SemanticKITTI.")
        ...
        if not self.test_mode and is_not_semkitti:
    ...
    def load_annotations(self, ann_file):
        ...
        if not ann_file.endswith(ann_file):
    ...
    def __getitem__(self, idx):
        ...
        while True:
            # TODO: the following hack is reserved only for debugging
            # import random
